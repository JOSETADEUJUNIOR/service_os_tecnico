...
<body class="skin-1">
	...
	<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Tipos de equipamentos</li>
					</ul><!-- /.breadcrumb -->
				</div>
				<!-- conteudo da pagina -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h4 class="pink">
										<a href="#tipoequipamento" role="button" class="btn btn-success" data-toggle="modal"><i class="ace-icon fa fa-plus white"></i>Novo</a>
									</h4>
									<div class="table-header">
										Tipos de equipamentos Cadastrados
										
										<div style="display:inline-flex" id="dynamic-table_filter">
											<input type="search" onkeyup="FiltrarTipo(this.value)" class="form-control input-sm" placeholder="buscar por tipo de equipamento" aria-controls="dynamic-table">
										</div>
									</div>
		...
		<form id="form_tipoequip" action="setor.php" method="post">
			<?php include_once 'modal/_tipoequipamento.php' ?>
